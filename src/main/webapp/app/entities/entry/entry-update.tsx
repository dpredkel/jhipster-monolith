  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterMonolithApp.entry.home.createOrEditLabel">
            <Translate contentKey="jhipsterMonolithApp.entry.home.createOrEditLabel">Create or edit a Entry</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : entryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="titleLabel" for="entry-title">
                  <Translate contentKey="jhipsterMonolithApp.entry.title">Title</Translate>
                </Label>
                <AvField
                  id="entry-title"
                  type="text"
              ...
              <AvGroup>
                <Label id="contentLabel" for="entry-content">
                  <Translate contentKey="jhipsterMonolithApp.entry.content">Content</Translate>
                </Label>
                <AvInput
                  id="entry-content"
                  type="textarea"
              ...
              <AvGroup>
                <Label id="dateLabel" for="entry-date">
                  <Translate contentKey="jhipsterMonolithApp.entry.date">Date</Translate>
                </Label>
                <AvInput
                  id="entry-date"
                  type="datetime-local"
              ...
              <AvGroup>
                <Label for="entry-blog">
                  <Translate contentKey="jhipsterMonolithApp.entry.blog">Blog</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="entry-tag">
                  <Translate contentKey="jhipsterMonolithApp.entry.tag">Tag</Translate>
                </Label>
                <AvInput
                  id="entry-tag"
                  type="select"
