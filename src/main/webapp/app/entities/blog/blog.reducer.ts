...
export const getSearchEntities: ICrudSearchAction<IBlog> = (query, page, size, sort) => ({
  type: ACTION_TYPES.SEARCH_BLOGS,
  payload: axios.get<IBlog>(`${apiSearchUrl}?query=${query}`),
});
