...
import { getSearchEntities, getEntities, reset } from './tag.reducer';
...
export const Tag = (props: ITagProps) => {
  ...
  return (
    <div>
      <h2 id="tag-heading">
        <Translate contentKey="jhipsterMonolithApp.tag.home.title">Tags</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterMonolithApp.tag.home.createLabel">Create new Tag</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('jhipsterMonolithApp.tag.home.search')}
                />
          ...
          {tagList && tagList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('name')}>
                    <Translate contentKey="jhipsterMonolithApp.tag.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="jhipsterMonolithApp.tag.home.notFound">No Tags found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
